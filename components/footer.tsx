...
export default function Footer() {
  return (
    <footer className="surface-dark border-t border-primary-foreground/10 px-6 py-10 lg:px-12">
      <div className="mx-auto flex max-w-7xl flex-col justify-between gap-6 sm:flex-row sm:items-end">
        <div>
          <p className="section-kicker text-secondary">
            SIG Surabaya / Employee Gathering 2026
          </p>
          <p className="display-serif mt-3 text-3xl text-primary-foreground">
            {GENERAL_INFO.theme}
          </p>
        </div>
