...
export const BUS_SEATS: BusSeat[] = [
  ...
  { id: 60, attendeeName: 'ada' },
];

export const BUS_SEATS_1: BusSeat[] = [
  { id: 1, attendeeName: 'Pak Zainil' },
  { id: 2, attendeeName: 'Pak Aryo' },
  { id: 3, attendeeName: 'Crew' },
  { id: 4, attendeeName: 'Bayu' },
  ...
  { id: 29, attendeeName: 'Puja' },
  { id: 30, attendeeName: 'Anissa' },
  { id: 31, attendeeName: 'Kosong' },
];

export const BUS_SEATS_2: BusSeat[] = [
  { id: 1, attendeeName: 'Lina' },
  { id: 2, attendeeName: 'Friska' },
  { id: 3, attendeeName: 'Tiara' },
  { id: 4, attendeeName: 'Shofi' },
  { id: 5, attendeeName: 'Anti' },
  { id: 6, attendeeName: 'Icha' },
  { id: 7, attendeeName: 'Sanah' },
  { id: 8, attendeeName: 'Dicky' },
  { id: 9, attendeeName: 'Naufal' },
  { id: 10, attendeeName: 'Badri' },
  { id: 11, attendeeName: 'Bais' },
  { id: 12, attendeeName: 'Rizda' },
  { id: 13, attendeeName: 'Iqbal' },
  { id: 14, attendeeName: 'Edy' },
  { id: 15, attendeeName: 'Dany' },
  { id: 16, attendeeName: 'Alif' },
  { id: 17, attendeeName: 'Mirzaq' },
  { id: 18, attendeeName: 'Wahyu' },
  { id: 19, attendeeName: 'Maudy' },
  { id: 20, attendeeName: 'Happy' },
  { id: 21, attendeeName: 'Ali' },
  { id: 22, attendeeName: 'Crew' },
  { id: 23, attendeeName: 'Crew' },
  { id: 24, attendeeName: 'Danu' },
  { id: 25, attendeeName: 'Rian' },
  { id: 26, attendeeName: 'Eko' },
  { id: 27, attendeeName: 'Bahar' },
  { id: 28, attendeeName: 'Refo' },
  { id: 29, attendeeName: 'Ferry' },
  { id: 30, attendeeName: 'Kosong' },
  { id: 31, attendeeName: 'Kosong' },
];
